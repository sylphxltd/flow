...
try {
  ...
  buildSpinner.succeed(`Built ${chalk.cyan(result.outputs.length)} output files`);
} catch (error) {
...
console.log(chalk.dim('ℹ Native dependencies will be resolved from node_modules at runtime.\n'));
