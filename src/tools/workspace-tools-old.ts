...
// TODO: Update to use new workspace reasoning tools
// Temporary import for build compatibility
import { frameworkRegistry, type ReasoningFramework } from '../domains/workspace/reasoning/framework-registry.js';
...
export function registerAllWorkspaceTools(server: McpServer) {
  ...
  // DISABLED: Replaced with prompt-embedded framework templates
  // See: Decision D002 in task optimize-master-craf-d8f9a5
  // Reasoning now uses embedded templates in agent prompt + workspace_create_file for documentation
