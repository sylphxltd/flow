 ...
 */
export function removeQuotes(title) {
 ...
 */
export function removeTitlePrefix(title) {
 ...
 */
export function cleanAITitle(title, maxLength = 50) {
 ...
 */
export function formatSessionDisplay(title, created) {
 ...
 */
export function needsTruncation(title, maxLength = 50) {
 ...
 */
export function isValidTitle(title, maxLength = 100) {
 ...
 */
export function extractTitleFromMessage(message, maxLength = 50) {
    // Take first line
