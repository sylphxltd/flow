...
const tokenizerInitializing = new Set();
const tokenizerFailed = new Set();
 ...
 */
export async function countTokensForModel(text, modelName) {
 ...
 */
export async function countAndFormat(text, modelName) {
 ...
 */
export function countAndFormatSync(text) {
 ...
 * Uses BPE tokenizer
 */
export async function countTokensBatch(texts, modelName) {
 ...
 */
export async function getTokenizerInfo(modelName) {
    const tokenizerName = getTokenizerForModel(modelName);
    const tokenizer = await ensureTokenizer(modelName);
    return {
