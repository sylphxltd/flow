...
export const messageRouter = router({
    ...
    add: publicProcedure
        ...
        return await ctx.sessionRepository.addMessage(input.sessionId, input.role, input.content, input.attachments, input.usage, input.finishReason, input.metadata, input.todoSnapshot, input.status);
    }),
    /**
