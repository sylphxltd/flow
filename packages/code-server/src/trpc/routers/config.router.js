...
import { loadAIConfig, saveAIConfig, getAIConfigPaths, getProvider, AI_PROVIDERS, fetchModels, getTokenizerInfo, } from '@sylphx/code-core';
...
function sanitizeAIConfig(config) {
    ...
    for (const [providerId, providerConfig] of Object.entries(config.providers)) {
        ...
        try {
            ...
            secretFields = new Set(configSchema
...
export const configRouter = router({
    ...
    fetchModels: publicProcedure
        ...
        try {
            ...
            const providerConfig = configResult._tag === 'Success' ? configResult.value.providers?.[input.providerId] || {} : {};
    ...
    onChange: publicProcedure
        ...
        return observable((emit) => {
            ...
            const unsubscribe = eventBus.onAppEvent((event) => {
                ...
                else if (event.type === 'config:provider-added' ||
