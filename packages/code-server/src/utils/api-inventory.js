 ...
 * Get API inventory
 */
export function getAPIInventory() {
    return API_INVENTORY;
}
/**
 * Get endpoints by authentication level
 */
export function getEndpointsByAuth(auth) {
...
export function searchEndpoints(query) {
    ...
    return API_INVENTORY.endpoints.filter((e) => e.path.toLowerCase().includes(lowerQuery) ||
...
//# sourceMappingURL=api-inventory.js.map