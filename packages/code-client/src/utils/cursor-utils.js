 ...
 */
export function getCursorLinePosition(text, cursor) {
 ...
 */
export function getAbsoluteCursorPosition(text, line, column) {
    const lines = text.split('\n');
    let position = 0;
 ...
 */
export function moveCursorUp(text, cursor) {
 ...
 */
export function moveCursorDown(text, cursor) {
    const lines = text.split('\n');
    const { line, column } = getCursorLinePosition(text, cursor);
 ...
 */
export function clampCursor(cursor, textLength) {
