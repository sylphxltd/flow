...
function getOpenCodeConfigPath(cwd) {
  return import_node_path.default.join(cwd, "opencode.jsonc");
}
...
async function promptForAPIKeys(serverTypes) {
  ...
  for (const serverType of serverTypes) {
    const server2 = MCP_SERVERS[serverType];
    if (!server2?.requiredEnvVars?.length) continue;
    console.log(`
\u{1F511} Configuring API keys for ${server2.description}:`);
    for (const envVar of server2.requiredEnvVars) {
...
async function configureMCPServer(cwd, serverType) {
  ...
  if (!server2.requiredEnvVars?.length) {
    console.log(`\u2139\uFE0F  ${server2.name} does not require any API keys`);
    return;
  }
  console.log(`\u{1F527} Configuring ${server2.description}...`);
  ...
  const currentConfig = config.mcp[server2.name];
  if (currentConfig && currentConfig.type === "local") {
    config.mcp[server2.name] = {
      ...currentConfig,
      environment: {
    ...
    const baseConfig = server2.config;
    if (baseConfig.type === "local") {
      ...
      config.mcp[server2.name] = baseConfig;
    }
  }
  await writeOpenCodeConfig(cwd, config);
  console.log(`\u2705 Updated ${server2.name} with API keys`);
}
...
function collectFiles(dir, extensions) {
  ...
  function traverse(currentDir) {
    ...
    for (const item of items) {
      const fullPath = import_node_path2.default.join(currentDir, item);
      const stat = import_node_fs.default.statSync(fullPath);
      if (stat.isDirectory()) {
        traverse(fullPath);
      } else if (extensions.some((ext) => item.endsWith(ext))) {
        const relativePath = import_node_path2.default.relative(dir, fullPath);
...
function clearObsoleteFiles(targetDir, expectedFiles, extensions, results2) {
  ...
  const items = import_node_fs.default.readdirSync(targetDir);
  for (const item of items) {
    const itemPath = import_node_path2.default.join(targetDir, item);
    const stat = import_node_fs.default.statSync(itemPath);
    if (stat.isFile()) {
      const hasValidExtension = extensions.some((ext) => item.endsWith(ext));
      if (hasValidExtension && !expectedFiles.has(item)) {
        import_node_fs.default.unlinkSync(itemPath);
        results2.push({
          file: item,
          status: "skipped",
...
function createMergedContent(filePaths, processContent, title, pathPrefix = "") {
  ...
  for (const filePath of filePaths) {
    const fullPath = import_node_path2.default.resolve(filePath);
    if (import_node_fs.default.existsSync(fullPath)) {
      const content = import_node_fs.default.readFileSync(fullPath, "utf8");
      const processedContent = processContent(content);
      sections.push(`## ${import_node_path2.default.basename(filePath, ".md")}`);
      sections.push("");
...
async function getAgentFiles() {
  ...
  for (const subdir of subdirs) {
    const subdirPath = import_node_path3.default.join(agentsDir, subdir);
    const files = collectFiles(subdirPath, [".md"]);
    allFiles.push(...files.map((file) => import_node_path3.default.join(subdir, file)));
  }
  return allFiles;
}
...
async function installAgents(options) {
  ...
  const agentsDir = import_node_path3.default.join(cwd, config.dir);
  const processContent = (content) => {
    return content;
  };
  if (options.clear && import_node_fs2.default.existsSync(agentsDir)) {
    let expectedFiles;
    if (options.merge) {
      ...
      expectedFiles = new Set(
        agentFiles2.map((filePath) => {
          const parsedPath = import_node_path3.default.parse(filePath);
  ...
  if (options.merge) {
    ...
    const mergedFilePath = import_node_path3.default.join(agentsDir, mergedFileName);
    ...
    if (contentChanged) {
      import_node_fs2.default.writeFileSync(mergedFilePath, mergedContent, "utf8");
      results2.push({
        file: mergedFileName,
    ...
    if (options.mcp !== false) {
      ...
      if (options.dryRun) {
        ...
        const serversNeedingKeys = allServers.filter(
          (server2) => ["gpt-image", "perplexity", "gemini-search"].includes(server2)
        );
...
var FullscreenMemoryTUI = () => {
  ...
  const memory = (0, import_react.useMemo)(() => new LibSQLMemoryStorage(), []);
  ...
  const saveEntry = (0, import_react.useCallback)(
  ...
  const deleteEntry = (0, import_react.useCallback)(
    async (entry) => {
      try {
  ...
  const searchEntries = (0, import_react.useCallback)((query, entries) => {
    if (!query.trim()) {
  ...
  const renderList = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { borderStyle: "double", borderColor: "blue", padding: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "\u{1F9E0} Memory Manager" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "[\u2191\u2193] Select [Enter] View [Space] Edit [n] New [d] Delete [/] Search [r] Refresh [?] Help [Ctrl+C] Quit" }) }),
  ...
  const renderView = () => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "double", borderColor: "cyan", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "cyan", children: "\u{1F4C4} View Entry" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "[\u2191\u2193] Scroll [Space] Edit [ESC] Back" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginBottom: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "Namespace:" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginBottom: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "Key:" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
            " ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginBottom: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "Updated:" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
            " ",
            state.selectedEntry.updated_at
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", flexGrow: 1, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "Value:" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            import_ink.Box,
            {
              ...
              flexGrow: 1,
              children: [
                visibleLines.map((line, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: line }, index)),
                lines.length > 20 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { color: "gray", children: [
                  "--- ",
                  lines.length - 20,
                  " more lines ---"
                ] })
  ...
  const renderEdit = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "double", borderColor: "yellow", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "yellow", children: "\u270F\uFE0F Edit Entry" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "[Enter] Save [ESC] Cancel [\u2191\u2193\u2190\u2192] Navigate text" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginBottom: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "Namespace:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", flexGrow: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "blue", children: "JSON Value:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          import_ink.Box,
          {
            flexDirection: "column",
            ...
            flexGrow: 1,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "Edit JSON content:" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: state.editForm.value }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "_" })
              ] })
            ]
          }
        )
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, borderStyle: "single", borderColor: "gray", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "Tip: Enter valid JSON format, then press Enter to save" }) })
  ] });
  const renderAdd = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "double", borderColor: "green", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "green", children: "\u2795 Add Entry" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "[Tab] Switch fields [Enter] Save [ESC] Cancel" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginBottom: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { bold: true, color: state.addForm.field === "namespace" ? "green" : "blue", children: [
        "Namespace: ",
        state.addForm.namespace,
        state.addForm.field === "namespace" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "_" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginBottom: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { bold: true, color: state.addForm.field === "key" ? "green" : "blue", children: [
        "Key: ",
        state.addForm.key,
        state.addForm.field === "key" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "_" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", flexGrow: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: state.addForm.field === "value" ? "green" : "blue", children: "JSON Value:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          import_ink.Box,
          {
            flexDirection: "column",
            ...
            flexGrow: 1,
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "Enter JSON value:" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: state.addForm.value }),
                state.addForm.field === "value" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "_" })
              ] })
            ]
          }
        )
  ...
  const renderSearch = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "double", borderColor: "magenta", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "magenta", children: "\u{1F50D} Search Entries" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "gray", children: "Type search term, Enter to confirm, ESC to cancel" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "Search: " }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: state.searchQuery }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { children: "_" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { color: "gray", children: [
      ...
      state.filteredEntries.slice(0, 10).map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
        "\u2022 ",
        entry.namespace,
        ":",
        entry.key
      ] }) }, index)),
      state.filteredEntries.length > 10 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { color: "gray", children: [
        "... and ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, justifyContent: "center", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { marginTop: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          ...
          " - No, cancel |",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "ESC" }),
          " - Back"
        ] }) })
      ] })
    ] })
  ...
  const renderHelp = () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", height: "100%", width: "100%", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "double", borderColor: "green", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "green", children: "\u{1F4D6} Memory Manager - Help" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { marginTop: 1, flexDirection: "column", flexGrow: 1, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", marginBottom: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "cyan", children: "Basic Operations:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Enter" }),
          " - View selected entry details"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Space" }),
          " - Edit selected entry"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", marginBottom: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "cyan", children: "Edit Mode:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Enter" }),
          " - Save changes"
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Backspace" }),
          " - Delete text"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", marginBottom: 1, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "cyan", children: "Add Mode:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Tab" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Box, { flexDirection: "column", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { bold: true, color: "cyan", children: "System:" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "?" }),
          " or ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Ctrl+H" }),
          " - Toggle help"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_ink.Text, { children: [
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { color: "cyan", children: "Ctrl+C" }),
          " - Force exit"
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Box, { borderStyle: "single", borderColor: "gray", padding: 1, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ink.Text, { dimColor: true, children: "Press ? or Ctrl+H to close help" }) })
  ] });
  if (state.showHelp) {
    return renderHelp();
  }
...
var handleMemoryTui = async () => {
  ...
  const { waitUntilExit } = (0, import_ink2.render)(import_react2.default.createElement(FullscreenMemoryTUI), {
